...
/**
 * An instance of this class is created by the server when a ocsf.client connects. It
 * accepts messages coming from the ocsf.client and is responsible for sending data
 * to the ocsf.client since the socket is private to this class. The AbstractServer
...
public class ConnectionToClient extends Thread {
	...
	/**
	 * Stream used to read from the ocsf.client.
	 */
	private ObjectInputStream	input;

	/**
	 * Stream used to write to the ocsf.client.
	 */
	...
	/**
	 * Map to save information about the ocsf.client such as its login ID. The
	 ...
	 * ocsf.client. Used by the setInfo and getInfo methods.
	 */
	...
	/**
	 * Constructs a new connection to a ocsf.client.
	 * 
	 * @param group
	 *            the thread groupSystem.out.println("Client at "+ ocsf.client +
	 *            "connected"); that contains the connections.
	 * @param clientSocket
	 *            contains the ocsf.client's socket.
	 * @param server
	 *            a reference to the server that created this instance
	...
	/**
	 * Sends an object to the ocsf.client.
	 * 
	 * @param msg
    ...
    * in some circumstances when Java refuses to send data that it thinks has been sent.
	...
	/**
	 * Closes the ocsf.client. If the connection is already closed, this call has no
	 * effect.
	 * 
	 * @exception IOException
	...
	/**
	 * Returns the address of the ocsf.client.
	 * 
	 * @return the ocsf.client's Internet address.
	 */
	...
	/**
	 * Returns a string representation of the ocsf.client.
	 * 
	 * @return the ocsf.client's description.
	 */
	...
	/**
	 * Saves arbitrary information about this ocsf.client. Designed to be used by
	...
	/**
	 * Returns information about the ocsf.client saved using setInfo. Based on a hash
	 * map.
	 * 
	 * @param infoType
	 *            identifies the type of information
	...
	/**
	 * Constantly reads the ocsf.client's input stream. Sends all objects that are
	...
	final public void run() {
		...
		// from clients
		try {
			// The message from the ocsf.client
			Object msg;

			while (!readyToStop) {
				// This block waits until it reads a message from the ocsf.client
