 ...
 * up the ocsf.client side of a ocsf.client-server architecture. When a ocsf.client is thus
...
public abstract class AbstractClient implements Runnable {
    ...
    * in some circumstances when Java refuses to send data that it thinks has been sent.
	...
	/**
	 * @return true if the ocsf.client is connnected.
	 */
	...
	/**
	 * returns the ocsf.client's description.
	 * 
	 * @return the ocsf.client's Inet address.
	 */
	...
	/**
	 * Hook method called each time an exception is thrown by the ocsf.client's
	...
	/**
	 * Handles a message sent from the server to this ocsf.client. This MUST be
