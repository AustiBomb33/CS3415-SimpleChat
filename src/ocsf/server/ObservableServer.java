...
public class ObservableServer extends Observable
{
  ...
  /**
   * The string sent to the observers when a ocsf.client has connected.
   */
  public static final String CLIENT_CONNECTED= "#OS:Client connected.";

  /**
   * The string sent to the observers when a ocsf.client has disconnected.
   */
  public static final String CLIENT_DISCONNECTED= "#OS:Client disconnected.";

  /**
   * The string sent to the observers when an exception occurred with a ocsf.client.
...
// ACCESSING METHODS ------------------------------------------------
   ...
   * is raised in a ocsf.client thread.
   * This implementation simply closes the
   * ocsf.client connection, ignoring any exception.
   * The method may be overridden by subclasses.
   *
  ...
  /**
   * This method is used to handle messages coming from the ocsf.client.
   * Observers are notfied by receiveing the transmitted message.
   * Note that, in this implementation, the information concerning
   * the ocsf.client that sent the message is lost.
   * It can be overriden, but is still expected to call notifyObservers().
   *
   * @param message The message received from the ocsf.client.
   * @param client The connection to the ocsf.client.
