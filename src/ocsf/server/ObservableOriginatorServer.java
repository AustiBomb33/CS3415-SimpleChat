...
public class ObservableOriginatorServer extends ObservableServer
{
   ...
   * ocsf.client who sent the message.
   *
  ...
  /**
   * Method called each time a new ocsf.client connection is
   * accepted. It notifies observers by sending an
   * <code> OriginatorMessage </code> instance
   * containing a reference to that ocsf.client and
  ...
  /**
   * Method called each time a ocsf.client connection is
