...
// ACCESSING METHODS ------------------------------------------------
  ...
  /**
   * @used to find out if the ocsf.client is connnected.
   */
   ...
   * Only has effect if the ocsf.client is not currently connected.
   *
   ...
   * is raised by the ocsf.client listening thread.
   *
